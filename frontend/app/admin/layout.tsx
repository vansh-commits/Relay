  ...
  return (
    <div className="flex h-screen bg-bg-base">
      ...
      <aside className="w-56 bg-bg-surface border-r border-border flex flex-col flex-shrink-0">
        ...
        <div className="px-4 py-4 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted leading-none mt-0.5">Admin</p>
            </div>
          </div>
        </div>
        ...
        {/* Back to Chat — prominent CTA */}
        <div className="px-3 pb-4 pt-2 border-t border-border">
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full px-3 py-2 rounded-lg bg-bg-elevated border border-border text-sm text-text-secondary hover:text-text-primary hover:bg-bg-hover transition-colors"
          >
